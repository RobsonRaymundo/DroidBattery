...
public class DroidTime extends DialogPreference {
	...
	public DroidTime(Context ctxt) {
		this(ctxt, null);
	}

	public DroidTime(Context ctxt, AttributeSet attrs) {
		this(ctxt, attrs, 0);
	}

	public DroidTime(Context ctxt, AttributeSet attrs, int defStyle) {
